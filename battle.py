...
def battle(executionNO):
  try:
      ...
      #battle using ticket
      try:
          driver.find_element(By.LINK_TEXT,"Start fighting").click()
      ...
      while True:
          ...
          if hp_OP_ == 0:
              ...
              if coolURL in allImages or conText == 'You want to...\nAccept offering and quit fighting':
                  ...
                  tot_ext_t=exe_t+tot_ext_t
                  avg_ext_t=round((tot_ext_t/itn),3)
                  print("Attempt No.:  {}  || Execution took: {}s || Average Time: {}s".format(itn,exe_t,avg_ext_t))
                  start_t=time.perf_counter()
                  if itn ==executionNO:
                      condtn = False
                      driver.get("https://gridplays.com/logout")
...
logIN(userNo)
condtn=input('Do you want to Start Feed and Play? \nPress "y": ')
if condtn=="y":
    feednPlay()
    print("Feed and Play Done")
else:
    print("Feed and Play skipped")
