...
# chrome_options.add_argument("--user-data-dir=/home/gamesploiter/.config/google-chrome")
...
def send8Trophy():
    ...
    for i in trophyId:
        s_url= "https://gridplays.com/qute/trophy/index/act/select/id/{}/subpage/0/src/board?{}".format(i,getToken())
        print(s_url)
        driver.refresh()
        time.sleep(15)
        driver.get(s_url)
...
def sendMaxPointTrophy():
    driver.get("https://gridplays.com/qute/trophy/index/act/select/src/board")
    while True:
        s_url= "https://gridplays.com/qute/trophy/index/act/select/id/{}/subpage/0/src/board?{}".format(maxTrophyid,getToken())
        print(s_url)
        driver.refresh()
        time.sleep(15)
        driver.get(s_url)
...
trophyId=["217","218","225","226","229","236","237","292","293"]
user=int(input("Enter login ID: "))
maxTrophyid=input("Enter max points trophy ID: ")
conditn=input("Enter y to start sending 8 trophies: ")
trophyId.remove(maxTrophyid)
logIn(user)
if conditn == "y":
    send8Trophy()
else:
